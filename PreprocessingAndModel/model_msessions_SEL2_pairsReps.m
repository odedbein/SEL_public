...
%% MODEL PAIRS BASED ON REPETITIONS

%PRE LEARNING SIMILARITY
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
resultsdir='results_pairsRep_smt_norm_msessions';
onsetdir='onsets';
%ntp=400;
...
filefilter = '^swua.*\.nii';%'^swra.*\.nii'; % '^s.*\.img'; % pre-processed images
...
runs_onsets = 	{...
    'onsets_SEL2_pairsRep_sess1';...
    'onsets_SEL2_pairsRep_sess2';...
    'onsets_SEL2_pairsRep_sess3';...
    'onsets_SEL2_pairsRep_sess4';...
    };
...
%    jobs{2}.stats{1}.fmri_spec.sess.multi = cellstr(fullfile(subj_path,onsetdir,onset)); % Load onsets matrix 
    ...
    save(fullfile(subj_path,'results_pairsRep_smt_norm_msessions.mat'),'jobs');
