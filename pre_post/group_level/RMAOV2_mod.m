...
if showtable
  ...
  disp('  ');
  fprintf('The percentage of the variability in the DV associated with the IV1 (partial eta squared) is% 3.2f\n', eta21);
  disp('(After the effects of individual differences have been removed).');
  disp('  ');
  fprintf('The percentage of the variability in the DV associated with the IV2 (partial eta squared) is% 3.2f\n', eta22);
  disp('(After the effects of individual differences have been removed).');disp('  ');
  fprintf('The percentage of the variability in the DV associated with the IV*IV2 (partial eta squared) is% 3.2f\n', eta_int);
  disp('(After the effects of individual differences have been removed).');disp('  '); 
end
